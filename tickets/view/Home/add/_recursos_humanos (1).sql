...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2023 a las 00:12:17
...
(136, 'Julio cesar Bello-Amigo', 2147483647, 136);
...
(136, 'INDETERMINADO', '2020-07-09', '0000-00-00', 2.8, 136);
...
CREATE TABLE `departamento` (
  ...
  `sueldo_semanal` float NOT NULL,
  `sueldo_mensual` float NOT NULL,
  `id_empleado` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(135, 'SISTEMAS ', 'PROGRAMADOR DE REALIDAD VIRTUA', 3000, 12000, 135),
(136, 'SISTEMAS', 'DESARROLLADOR WEB', 0, 0, 136);
...
CREATE TABLE `empleados` (
  ...
  `originario` varchar(15) NOT NULL,
...
--
ALTER TABLE `beneficiario`
  MODIFY `id_beneficiario` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `contacto_emergencia`
--
ALTER TABLE `contacto_emergencia`
  MODIFY `id_contacto` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `contrato`
--
ALTER TABLE `contrato`
  MODIFY `id_contrato` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `datos_fiscales`
--
ALTER TABLE `datos_fiscales`
  MODIFY `id_datosFiscales` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `departamento`
--
ALTER TABLE `departamento`
  MODIFY `id_departamento` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT de la tabla `empleados`
--
ALTER TABLE `empleados`
  MODIFY `id_empleado` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
...
--
ALTER TABLE `contacto_emergencia`
  ADD CONSTRAINT `contacto_emergencia_ibfk_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`);

--
-- Filtros para la tabla `contrato`
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `contrato_ibfk_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`);
